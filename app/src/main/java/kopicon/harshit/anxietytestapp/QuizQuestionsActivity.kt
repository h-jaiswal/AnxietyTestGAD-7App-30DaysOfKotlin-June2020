...
//
                    ...
                    if(mSelectedOptionPosition == 1) {
                        mTotalScore += question!!.scoreOne
                    } else if (mSelectedOptionPosition == 2) {
                        mTotalScore += question!!.scoreTwo
                    } else if (mSelectedOptionPosition == 3) {
                        mTotalScore += question!!.scoreThree
                    } else if (mSelectedOptionPosition == 4) {
                        mTotalScore += question!!.scoreFour
                    }

//                    // This is to check if the answer is wrong
//                    if (question!!.scoreOne != mSelectedOptionPosition) {
////
...
//                    answerView(question!!.scoreOne, R.drawable.correct_option_border_bg)
